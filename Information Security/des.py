# Practical 6 Data Encryption Standards
########################################################
# Author    -   Karan Gupta
# Roll No.  -   2020PMD4224
...
# S-box Table 
sbox =  [[[14, 4, 13, 1, 2, 15, 11, 8, 3, 10, 6, 12, 5, 9, 0, 7],                                 # S-Box 1
...
def des(message, rkb, rk): 
    message = hex2bin(message) 
      
    # Initial Permutation 
    message = permute(message, initial_perm, 64) 
    print("After inital permutation", bin2hex(message)) 
    ...
    for i in range(0, 16): 
        ...
        print("Round ", i + 1, " Left Part- ", bin2hex(left), " Right Part- ", bin2hex(right), " Current Round Key- ", rk[i]) 
...
if __name__ == "__main__":
    ...
    print("Encryption") 
    cipher_text = bin2hex(des(plaintext, rkb, rk)) 
    print("Cipher Text : ",cipher_text) 
    
    print("Decryption") 
    rkb_rev = rkb[::-1] 
    rk_rev = rk[::-1] 
    text = bin2hex(des(cipher_text, rkb_rev, rk_rev)) 
