# Practical 7 Advanced Encryption Standards
########################################################
# Author    -   Karan Gupta
# Roll No.  -   2020PMD4224
...
if __name__ == '__main__':
    ...
    KEYS = str(input("Enter a Key for Encryption : "))
    TEXTS = str(input("Enter a Text for Encryption : "))
    
    main_key = translate_string_into_hex_str(KEYS)
    main_text = translate_string_into_hex_str(TEXTS)
    ...
    print("\nKey : \'{}\'".format(KEYS))
    print("Message Text : \'{}\'".format(TEXTS))
    print("Length of Text :", len(str(TEXTS)))
